...
public class BorderUpdate : MonoBehaviour {
	...
	void Update () {
		topSide.center = new Vector2 ( mainCam.ScreenToWorldPoint (new Vector3 (Screen.width, 0f, 0f)).x, mainCam.ScreenToWorldPoint (new Vector3 (0f, Screen.height, 0f)).y + 0.5f);
		bottomSide.center = new Vector2 ( mainCam.ScreenToWorldPoint (new Vector3 (Screen.width, 0f, 0f)).x, mainCam.ScreenToWorldPoint (new Vector3 (0f, 0f, 0f)).y - 0.5f);
